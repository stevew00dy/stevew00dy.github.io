        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm text-text-dim leading-relaxed">
              <strong className="text-text">Your data, your responsibility.</strong> Our uNoob trackers
              don&apos;t store any personal information, and we never see your data. Progress stays in your
              browser. If you clear your cache, you&apos;ll lose it. Please use Export in each tool to back up
              regularly.
            </p>
          </div>
          <button
